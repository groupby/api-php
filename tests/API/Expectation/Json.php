...
class Json
{
  ...
  public static $BIASING = '{
    ...
    "augmentBiases":true,
    "biases":[
      {"name":"keys","content":"values","strength":"Strong_Increase"},
      {"name":"all","content":"my","strength":"Strong_Decrease"}
    ],
    "numericBoosts":[
      {"name":"test","inverted":false,"strength":1},
      {"name":"test2","inverted":true,"strength":2}
    ]}';
